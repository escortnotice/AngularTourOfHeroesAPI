...
public class ExceptionHandlerControllerAdvice extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		return BuildResponseUtil.buildErrorResponseObject(details,CustomErrorCodeAndMessages.INVALID_INPUT_DATA);
	}
	...
	protected ResponseEntity<Object> handleMissingServletRequestParameter(
	  ...
	  HttpStatus status, WebRequest request) {
	    ...
	    return BuildResponseUtil.buildErrorResponseObject(ex.getParameterName() + " parameter is missing",CustomErrorCodeAndMessages.BAD_REQUEST);
	}
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex, 
	    ...
	    return BuildResponseUtil.buildErrorResponseObject(ex.getMethod() + " method not supported" ,CustomErrorCodeAndMessages.BAD_REQUEST);
	}
	...
	public ResponseEntity<Object> handleMethodArgumentTypeMismatch(
	  MethodArgumentTypeMismatchException ex, WebRequest request) {
	    ...
	    return BuildResponseUtil.buildErrorResponseObject(ex.getName() + " should be of type " + ex.getRequiredType().getName(),CustomErrorCodeAndMessages.BAD_REQUEST);
	}
